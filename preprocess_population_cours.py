...
df = pd.read_csv(
    '../../../Bureau/ETS/H24/MGA802 programmation/Module 6/Ressource pour lexercice Population-20240212/9810000202-sanssymbole-mod.csv', delimiter=';', decimal=',', thousands=' ', usecols=(0, 1, 2, 3, 11))
